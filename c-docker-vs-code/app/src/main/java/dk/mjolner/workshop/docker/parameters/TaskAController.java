    ...
    public String aPage() throws IOException {
        return Utils.page(
                ...
                ul(
                        ...
                        Utils.bullet("We want to share a folder with the container. The folder is called 'a-docker-run/shared-folder' and located in the github repository: https://github.com/philter87/docker-workshop (you should use 'git clone'). The folder 'shared-folder' should be mounted and mapped to the path /app/shared-folder in the container. You need to use absolute paths. The syntax is -v <absolute-path-on-host>:<absolute-path-in-container>. Hint: In powershell, you can use ${PWD}\\shared-folder:/app/shared-folder", isVolumeShared())
                ),
